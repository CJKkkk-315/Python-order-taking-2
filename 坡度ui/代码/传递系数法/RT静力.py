...
# H=50;a=25;p=21;c=20;q=30;FS=1.25;Xl=0;Xr=110;B=-20;n=6;
    ...
    P = np.zeros(n)
    # print(P)
    P[0]=FS*(W[n-1]*S[n-1])-(c*L[n-1]+(W[n-1]*C[n-1])*k2)
    if P[0] < 0:
        P[0] = 0
    # print(P)
    for i in range(1,n):
        P[i]=FS*(W[n-i-1]*S[n-i-1])-(c*L[n-i-1]+(W[n-i-1]*C[n-i-1])*k2)+P[i-1]*m[n-i-1]
    # print(P)
    P1 = np.zeros(n)
    P1 = P[0:n-1]
    # print(P1)
...
# H=50;a=25;p=21;c=20;q=30;FS=1.25;Kh=0.1;Kv=0;fh=2;fv=0;t=0.2;vs=300;vp=0;Xl=0;Xr=110;B=-20;n=6;Fs=1.464
# H=10;a=25;p=21;c=20;q=30;FS=1.25;Kh=0.1;Kv=0;fh=0.5;fv=0;t=1;vs=100;vp=0;Xl=0;Xr=25;B=-20;n=6;Fs=2.081
U1(50,25,21,20,30,1.25,0.1,0,2,0,0.2,300,0,0,110,-20,6)