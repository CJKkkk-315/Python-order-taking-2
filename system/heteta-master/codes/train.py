...
from codes.util.data_loader import load_dataset
from codes.util.utils import tprint
from codes.model.supervisor import Supervisor
...
if __name__ == '__main__':
    ...
    print('start to get the HetETA_toy.taml')
